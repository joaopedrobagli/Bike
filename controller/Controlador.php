...
class Controlador {
    ...
    public function __construct() {
        $this->bancoDeDados = ControladorBD::criarBancoDeDados("localhost", "root", "", "bicicleta");
    }
    ...
    public function cadastrarCliente($nome, $email, $cpf, $senha) {
        $cliente = ClienteFactory::criarCliente($nome, $email, $cpf, $senha);
        $this->bancoDeDados->inserirCliente($cliente);
    }

    public function cadastrarProduto($nome, $valor, $caminhoImagem) {
        $produto = ProdutoFactory::criarProduto($nome, $valor, $caminhoImagem);
